...
const Sidebar = () => {
    ...
    return (
        <section className='sticky bg-slate-900 left-0 top-0 flex flex-col h-screen w-fit justify-between bg-palette-2 p-6 pt-28 hidden text-palette-4  md:block md:w-[30%]'>
